...
{
    class MainCharacterViewAnimations
    {
        ...
        int numFramesX;
        int numFramesY;
        public MainCharacterViewAnimations(Texture2D characterIdle, Texture2D characterWalkingLeft, Texture2D characterWalkingRight, Texture2D characterDead, MainCharacterModel mainModel, Camera _camera)
        {
            ...
            scale = camera.Scale(size, spriteHeight, spriteWidth);
            setIdle();
        }
